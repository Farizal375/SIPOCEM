...
import LogoutButton from "@/components/ui/logout-button"; // Import tombol fungsional
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="nama" defaultValue="Anggia Puspita" className="border-gray-200" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="email" className="text-gray-500">Email</Label>
                <Input id="email" defaultValue="giapuspita@gmail.com" className="border-gray-200" />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="role" defaultValue="Kader" disabled className="bg-white border-gray-200 text-gray-700" />
              </div>
